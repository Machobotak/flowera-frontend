  ...
  return (
    <div className="space-y-6">
      <div className="bg-white rounded-2xl p-6 shadow-soft border border-outline-variant/20">
        <h2 className="font-headline text-[24px] font-semibold text-on-surface mb-2">Selamat Datang di Seller Center!</h2>
        <p className="text-[14px] text-on-surface-variant">Kelola toko, pesanan, dan produk Anda dengan mudah dari halaman ini.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white rounded-2xl p-6 shadow-soft border border-outline-variant/20">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h3 className="text-[14px] font-semibold text-on-surface-variant">Pesanan Baru</h3>
        ...
        <div className="bg-white rounded-2xl p-6 shadow-soft border border-outline-variant/20">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h3 className="text-[14px] font-semibold text-on-surface-variant">Total Produk</h3>
              <p className="text-[24px] font-bold text-on-surface">0</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl p-6 shadow-soft border border-outline-variant/20">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h3 className="text-[14px] font-semibold text-on-surface-variant">Pendapatan</h3>
              <p className="text-[24px] font-bold text-on-surface">Rp 0</p>
            </div>
          </div>
        </div>
      </div>
